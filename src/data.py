...
#     the objects of interest may appear under various lighting or environmental conditions.
#     artificially increasing the diversity of training data
    ...
    data_loaders["test"] = torch.utils.data.DataLoader(
        # DONE(remember to add shuffle=False as well)
        test_data,
        batch_size=batch_size,
...
def visualize_one_batch(data_loaders, max_n: int = 5):
    ...
    dataiter = iter(data_loaders['train'])  # Obtain an iterator from the train dataloader
    images, labels = dataiter.next()  # Call the .next() method on the iterator
